...
if (!defined('STUDIOLSM_UTILS_PLUGIN_FILE')) {
    define('STUDIOLSM_UTILS_PLUGIN_FILE', __FILE__);
}

$build_dir = defined('STUDIOLSM_UTILS_BUILD_PATH') ? rtrim(STUDIOLSM_UTILS_BUILD_PATH, '/\\') . '/' : '';
$build_url = defined('STUDIOLSM_UTILS_BUILD_URL') ? rtrim(STUDIOLSM_UTILS_BUILD_URL, '/\\') . '/' : '';
$source_dir = plugin_dir_path(__FILE__);
$source_url = plugin_dir_url(__FILE__);

$active_dir = $build_dir && is_readable($build_dir . 'includes/class-autoloader.php') ? $build_dir : $source_dir;
$active_url = $build_dir && is_readable($build_dir . 'includes/class-autoloader.php') ? ($build_url ?: $source_url) : $source_url;

if (!defined('STUDIOLSM_UTILS_PLUGIN_DIR')) {
    define('STUDIOLSM_UTILS_PLUGIN_DIR', $active_dir);
}

if (!defined('STUDIOLSM_UTILS_PLUGIN_URL')) {
    define('STUDIOLSM_UTILS_PLUGIN_URL', $active_url);
}
